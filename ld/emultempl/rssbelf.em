...
# This file is sourced from elf.em, and defines extra rssb-elf
# specific routines.
#
fragment <<EOF

#include "ldctor.h"
#include "elf32-rssb.h"
...
rssbelf_after_parse (void)
{
  ...
  /* Don't create a demand-paged executable, since this feature isn't
     meaninful in rssb embedded systems. Moreover, when magic_demand_paged
...
static void
rssbelf_before_allocation (void)
{
  ...
  if (command_line.embedded_relocs
      ...
      for (abfd = link_info.input_bfds; abfd != NULL; abfd = abfd->link.next)
	{
	  ...
	  if (! bfd_rssb_elf32_create_embedded_relocs (abfd, &link_info,
						       datasec, relsec,
						       &errmsg))
	    {
	      if (errmsg == NULL)
...
# Put these extra rssb-elf routines in ld_${EMULATION_NAME}_emulation
#
LDEMUL_AFTER_OPEN=rssb_elf_after_open
LDEMUL_AFTER_PARSE=rssbelf_after_parse
LDEMUL_BEFORE_ALLOCATION=rssbelf_before_allocation
